      ...
      <div className="flex w-full items-center justify-center">
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <button
              type="submit"
              className="bottom-2.5 end-2.5 rounded-lg bg-blue-700 px-4 py-2 text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300"
            >
              Search
            </button>
          </div>
